...
internal fun Context.getUnsplashAccessKey() =
    getMetadataString("tw.com.deathhit.config.sunflower_clone.UNSPLASH_ACCESS_KEY")

internal fun Context.getUnsplashAppName() =
    getMetadataString("tw.com.deathhit.config.sunflower_clone.UNSPLASH_APP_NAME")

internal fun Context.getUnsplashServerUrl() =
    getMetadataString("tw.com.deathhit.config.sunflower_clone.UNSPLASH_SERVER_URL")
