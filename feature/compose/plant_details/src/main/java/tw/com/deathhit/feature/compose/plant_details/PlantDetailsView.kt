...
import tw.com.deathhit.core.app_ui_compose.style.Dimens
import tw.com.deathhit.core.app_ui_compose.style.SunflowerCloneTheme

@ExperimentalMaterial3Api
@Composable
internal fun PlantDetailsView(
    description: String,
    isPlanted: Boolean,
    ...
    SunflowerCloneTheme {
        ...
        Scaffold(
            ...
            floatingActionButton = {
                if (!isPlanted)
                    PlantFab(onFabClick = onFabClick)
            },
            topBar = {
                PlantDetailsTopBar(
                    plantName = plantName,
...
@Composable
private fun PlantDetailsTopBar(
    plantName: String,
    ...
    Column(modifier = modifier.padding(Dimens.PaddingLarge)) {
        Box(
            ...
            Column(Modifier.fillMaxWidth()) {
                ...
                Text(
                    text = stringResource(R.string.plant_details_every_x_days, wateringInterval),
                    modifier = Modifier
                        .align(Alignment.CenterHorizontally)
                )
            }
