...
import tw.com.deathhit.feature.compose.navigation.databinding.BlockGardenPlantingListBinding
import tw.com.deathhit.feature.compose.navigation.databinding.BlockPlantListBinding
...
@Composable
private fun NavigationPager(pagerState: PagerState, modifier: Modifier = Modifier) {
    Column(modifier = modifier) {
        NavigationTabRow(pagerState = pagerState)

        HorizontalPager(state = pagerState) { page ->
            when (NavigationPage.entries[page]) {
                NavigationPage.MY_GARDEN -> AndroidViewBinding(BlockGardenPlantingListBinding::inflate)
                NavigationPage.PLANT_LIST -> AndroidViewBinding(BlockPlantListBinding::inflate)
            }
        }
    }
}
